...
csv_file_path = os.path.join(base_path, 'products_prices.csv')
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.setStyleSheet('''
            QWidget {
                background-color: #c2d0a7; /* Light blueish background color */
            }
            QLabel {
            ...
            QPushButton:hover {
                background-color: #ecf7d5; /* Slightly darker blueish button color on hover */
            }
